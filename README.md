...
A modern and visually polished Tic Tac Toe game built using Python and Tkinter,<br> featuring a clean dark UI, real-time score tracking, and structured OOP design.</br>
